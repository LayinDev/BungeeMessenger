...
public class ConfigManager {
    ...
    public File getFile(){
            return new File(BMSGR.getInstance().getDataFolder(), "config.yml");
    }
    ...
    private void saveDefaultConfig(){
        ...
        if(!BMSGR.getInstance().getDataFolder().exists()){
            BMSGR.getInstance().getDataFolder().mkdir();
        }
        ...
        if(!file.exists()){
            ...
            try{
                ...
                file.createNewFile();
                InputStream is = BMSGR.getInstance().getResourceAsStream("config.yml");
